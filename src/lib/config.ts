  ...
  services: [
    {
      ...
      gallery: [
        { id: "laredo-wood-privacy-gallery-01", src: "/images/laredo-wood-privacy-gallery-01.webp", alt: "Worker hand holding a cedar post plumb in fresh concrete during a Laredo privacy fence install." },
        { id: "laredo-wood-privacy-gallery-02", src: "/images/laredo-wood-privacy-gallery-02.webp", alt: "Rails partially hung on a cedar privacy fence in Laredo; pickets stacked against the line." },
        { id: "laredo-wood-privacy-gallery-03", src: "/images/laredo-wood-privacy-gallery-03.webp", alt: "Board-on-board cedar privacy fence panel close-up in a Laredo backyard." },
        { id: "laredo-wood-privacy-gallery-04", src: "/images/laredo-wood-privacy-gallery-04.webp", alt: "Freshly completed cedar privacy fence stretching down the side of a Laredo home." },
        { id: "laredo-wood-privacy-gallery-05", src: "/images/laredo-wood-privacy-gallery-05.webp", alt: "Cedar cap detail at a wood privacy fence corner in Laredo; gloved hand visible at frame edge." },
      ],
    },
    {
      ...
      gallery: [
        { id: "laredo-chain-link-gallery-01", src: "/images/laredo-chain-link-gallery-01.webp", alt: "Vinyl-coated black chain-link terminal post being set in concrete in Laredo." },
        { id: "laredo-chain-link-gallery-03", src: "/images/laredo-chain-link-gallery-03.webp", alt: "Close-up of vinyl-coated black chain-link fabric on a Laredo fence; top rail visible above." },
        { id: "laredo-chain-link-gallery-04", src: "/images/laredo-chain-link-gallery-04.webp", alt: "Bottom-rail detail of a vinyl-coated chain-link fence in a Laredo dog run; rail 1-2 inches above grade." },
        { id: "laredo-chain-link-gallery-06", src: "/images/laredo-chain-link-gallery-06.webp", alt: "Long run of finished vinyl-coated chain-link fence at the back of a Laredo residential lot." },
      ],
    },
    {
      ...
      gallery: [
        { id: "laredo-wrought-iron-gallery-01", src: "/images/laredo-wrought-iron-gallery-01.webp", alt: "Spear-top ornamental iron fence panel installed at a Laredo home." },
        { id: "laredo-wrought-iron-gallery-02", src: "/images/laredo-wrought-iron-gallery-02.webp", alt: "Welding an ornamental iron panel to a post during a Laredo install; sparks visible." },
        { id: "laredo-wrought-iron-gallery-03", src: "/images/laredo-wrought-iron-gallery-03.webp", alt: "Ornamental iron fence enclosing a pool at a Laredo home; pool-code gate visible." },
        { id: "laredo-wrought-iron-gallery-04", src: "/images/laredo-wrought-iron-gallery-04.webp", alt: "Powder-coated black finish detail on an ornamental iron panel in Laredo." },
        { id: "laredo-wrought-iron-gallery-05", src: "/images/laredo-wrought-iron-gallery-05.webp", alt: "Fluted square post with a ball-finial cap on an ornamental iron fence in Laredo." },
      ],
    },
    {
      slug: "ranch-fence",
      ...
      gallery: [
        { id: "laredo-ranch-gallery-01", src: "/images/laredo-ranch-gallery-01.webp", alt: "Wooden H-brace assembly at a ranch fence corner south of Laredo." },
        { id: "laredo-ranch-gallery-02", src: "/images/laredo-ranch-gallery-02.webp", alt: "Pipe-and-cable ranch fence running across Webb County brush country." },
        { id: "laredo-ranch-gallery-04", src: "/images/laredo-ranch-gallery-04.webp", alt: "Four-strand barbed wire wrapped around a ranch fence corner post in Webb County." },
        { id: "laredo-ranch-gallery-05", src: "/images/laredo-ranch-gallery-05.webp", alt: "Game fence running along a slope in Webb County ranch country." },
        { id: "laredo-ranch-gallery-06", src: "/images/laredo-ranch-gallery-06.webp", alt: "Field fence with a 12-foot pipe gate at the entrance of a Webb County ranch road." },
      ],
    },
  ] satisfies Service[],
  faqs: [
